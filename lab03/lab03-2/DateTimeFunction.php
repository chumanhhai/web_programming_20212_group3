...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($time1 !== FALSE && $time2 !== FALSE) {
        ...
        echo sprintf("There are %s days  between first person's birthday and second person's birthday.<br>", $day_different);
        echo sprintf("There are %s year(s) between first person's birthday and second person's birthday.", abs($age2 - $age1));
    }
}
?>
</body>
